...
import com.chris.bullseye.service.AccountRoleService
...
class AccountRoleController(var accountRoleService: AccountRoleService,
                            ...
                            jsonResult: JsonResult<AccountRole>):BaseController<AccountRole>(jsonResult) {
    override fun service(): BaseService<AccountRole> {
