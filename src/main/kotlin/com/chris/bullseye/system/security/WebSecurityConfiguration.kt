...
class WebSecurityConfiguration: WebSecurityConfigurerAdapter() {
    ...
    override fun configure(http: HttpSecurity) {
        ...
        http.csrf().disable() // 开启跨域
                ...
                .antMatchers("/account/webLogin").permitAll()
                ...
                .antMatchers("/banner/getWebBanners").permitAll()
                .antMatchers("/navigation/getWebNavigation").permitAll()
                .antMatchers("/coursechapter/getWebChapters").permitAll()
                .antMatchers("/course/getByCourseId/*").permitAll()
                .antMatchers("/course/getHotCourseList").permitAll()
                .antMatchers("/course/getCourseListByPage").permitAll()
                .antMatchers("/course/getRecommendCourseList").permitAll()
                .antMatchers("/indexblock/getWebIndexBlock").permitAll()
                .antMatchers("/department/getWebDepartmentList").permitAll()
                .antMatchers("/major/getWebMajorList").permitAll()
                .antMatchers("/coursecategory/getWebCategoryList").permitAll()
                .antMatchers("/famousteacher/getFamousListByPage").permitAll()
